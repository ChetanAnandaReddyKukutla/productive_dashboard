...
function Dashboard() {
  ...
  const handleCreateTask = async () => {
    ...
    try {
      const res = await API.post(`/projects/${selectedProject}/tasks`, {
        title: newTaskTitle,
  ...
  return (
    ...
    >
      <div className="flex h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 overflow-hidden">
        {/* Mobile Header Bar */}
        <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-gray-900 bg-opacity-95 backdrop-blur-xl border-b border-gray-700 px-4 py-3 flex items-center justify-between">
          <button
          ...
          <h1 className="text-xl font-bold text-white">
            {selectedProject ? projects.find(p => p.id === selectedProject)?.title : 'ProductiveBoard'}
          </h1>
          {selectedProject && (
            <button
        ...
        <div className="flex-1 flex flex-col pt-16 lg:pt-0">
          ...
          <div className="hidden lg:block p-6 border-b border-gray-700 bg-gray-900 bg-opacity-50 backdrop-blur-md">
            {selectedProject ? (
